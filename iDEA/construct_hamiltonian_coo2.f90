...
!        a COOrdinate form of the system's Hamiltonian. These can then be
...
!and Mike Entwistle (me624@york.ac.uk)                                         !
...
subroutine construct_hamiltonian_coo(coo_1, coo_2, coo_data, h_diagonals, r,&
  ...
  do j = 1, grid-2
     do k = 1, grid-2
        ...
        !=======================================================!
        coo_1(i) = single_index(j+1, k, grid)
        coo_2(i) = jk
        coo_data(i) = -r
        i = i+1
        ...
        coo_1(i) = single_index(j, k+1, grid)
        coo_2(i) = jk
        coo_data(i) = -r
        i = i+1
